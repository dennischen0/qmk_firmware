 ...
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *            | LGUI | LAlt | LOWER|RAISE | /Space  /       \Enter \  | [    | ]    | -    | =    |
 *            |      |      |      |      |/       /         \      \ |      |      |      |      |
 *            `-----------------------------------'           '------''---------------------------'
 */
[_QWERTY] = LAYOUT( \
...
KC_LCTRL,   KC_A,   KC_S,    KC_D,    KC_F,    KC_G,                     KC_H,    KC_J,    KC_K,    KC_L, KC_SCLN,  KC_QUOT, \
 KC_LSFT,   KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_MUTE,    KC_MPLY,KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH,  KC_BSLS, \
            KC_LGUI, KC_LALT, MO(_LOWER), MO(_RAISE), KC_SPC,                  KC_ENT,  KC_LBRC, KC_RBRC, KC_MINS, KC_EQL  \
),
...
[_RAISE] = LAYOUT( \
  ...
  _______,  KC_INS,  KC_PSCR,   KC_APP,  XXXXXXX, XXXXXXX,                        KC_PGUP, XXXXXXX,   KC_UP, KC_LBRC, KC_RBRC, KC_BSPC, \
  _______, KC_LALT,  KC_LCTL,  KC_LSFT,  XXXXXXX, KC_CAPS,                       KC_PGDN,  KC_LEFT, KC_DOWN, KC_RGHT, XXXXXXX, KC_DEL, \
  _______,KC_UNDO, KC_CUT, KC_COPY, KC_PASTE, XXXXXXX,  _______,       _______,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,   XXXXXXX, XXXXXXX, \
              _______, _______, _______, _______, _______,                 _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX \
),
/* ADJUST
 * ,-----------------------------------------.                    ,-----------------------------------------.
...
[_ADJUST] = LAYOUT( \
  ...
  RESET   , XXXXXXX, TG(_QWERTY), TG(_GAMING), XXXXXXX, XXXXXXX,                     XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, \
